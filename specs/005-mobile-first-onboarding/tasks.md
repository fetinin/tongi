...
- [X] T011 [P] [US1] Integration test for blocking access until wallet connected in tests/integration/wallet-connection.test.ts
- [X] T012 [P] [US1] Integration test for redirect to buddy screen after wallet connection in tests/integration/wallet-connection.test.ts
...
- [X] T040 [US3] Update useOnboardingGuard to handle re-validation errors with retry UI in src/hooks/useOnboardingGuard.ts
- [X] T041 [US3] Add network error detection logic to distinguish from validation failures in src/hooks/useOnboardingGuard.ts
...
- [X] T046 [P] Add i18n support using next-intl for all onboarding screen text
