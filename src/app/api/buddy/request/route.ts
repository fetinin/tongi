  ...
  try {
    ...
    const response: BuddyPairResponse = {
      ...
      buddy: {
        ...
        telegramUsername: buddyPairWithProfile.buddy.telegramUsername,
        firstName: buddyPairWithProfile.buddy.firstName,
        tonWalletAddress: buddyPairWithProfile.buddy.tonWalletAddress,
        createdAt: buddyPairWithProfile.buddy.createdAt,
      },
