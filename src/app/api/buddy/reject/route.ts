...
export async function POST(
  ...
  try {
    ...
    // Parse request body
    const body: BuddyRejectInput = await request.json();
    ...
    // Reject buddy request using BuddyService
    const buddyPairWithProfile = await buddyService.rejectBuddyRequest(
      buddyPairId,
      userId
    );
    ...
    return handleApiError('buddy/reject:POST', error);
  }
}
