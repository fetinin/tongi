  ...
  try {
    ...
    const response: BuddyPairResponse = {
      ...
      buddy: {
        ...
        telegramUsername: buddyStatus.buddy!.telegramUsername,
        firstName: buddyStatus.buddy!.firstName,
        tonWalletAddress: buddyStatus.buddy!.tonWalletAddress,
        createdAt: buddyStatus.buddy!.createdAt,
      },
